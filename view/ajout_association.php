...
<div class="container">
  ...
  <form method="post">
    ...
    <div class="mb-3">
      ...
      <select name="id_conducteur" class="form-control" id="conducteur">
        <option value="choix1">Choisir le conducteur</option>
        <?php foreach (($conducteur->afficherLibre()) as $value) :  ?>
    ...
    <div class="mb-3">
      ...
      <select name="id_vehicule" class="form-control" id="vehicule">
        <option value="choix2">Choisir le V&eacute;hicule</option>
        <?php foreach (($vehicule->afficherVLlibre()) as $value) : ?>
